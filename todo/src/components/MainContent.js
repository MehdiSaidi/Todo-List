    ...
    hideCompletedOnClick() {
        ...
        for (i = 0; i < copyArray.length; i++) {
            if (copyArray[i].isCompleted == true) {
                ...
                copyItem.visibility == 'visible' ? copyItem.visibility = 'hidden' : copyItem.visibility = 'visible'
            ...
            <div className="MainContent">
                <div className="dropdown">
                    <button className="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                        ...
                        <i className="fa fa-ellipsis-h" aria-hidden="true" id="dotsIcon"></i>
                    ...
                    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a className="dropdown-item" href="#" onClick={this.hideCompletedOnClick.bind(this)}>Hide completed items</a>
                    </div>
                </div>
                <br></br>
                ...
                <TodoList todos={this.state.todoArray} isCompleteMethod={this.completedTodo.bind(this)} />
